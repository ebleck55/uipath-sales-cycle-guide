...
class AdminInterface {
  constructor() {
    ...
    this.contentAPI.baseUrl = '../../src/data/';
  ...
  async initializeInterface() {
    ...
    // Analytics filters
    const analyticsTimePeriodElement = document.getElementById('stats-time-period');
    if (analyticsTimePeriodElement) {
      analyticsTimePeriodElement.addEventListener('change', () => {
    ...
    // Site Statistics controls are now handled above with the statsTimePeriod variable
    ...
    // promptContextFilter is already handled above, removing duplicate
...
Make recommendations specific to UiPath automation solutions and enterprise sales scenarios. Focus on actionable content that can be created by the sales enablement team.`;
  ...
  initializePDFExtraction() {
    ...
    if (!uploadArea || !fileInput) {
      console.log('PDF extraction elements not found, skipping initialization');
      return;
    }
